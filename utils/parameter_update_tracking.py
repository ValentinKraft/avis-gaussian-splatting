...
class ParameterUpdateTracker:
    ...
    def update(self, model) -> Dict[str, float]:
        ...
        with torch.no_grad():
            ...
            # Scale updates
            if self.prev_scaling is not None and model._scaling.numel() > 0:
            ...
            # Rotation updates
            if self.prev_rotation is not None and model._rotation.numel() > 0:
            ...
            # Opacity updates
            if self.prev_opacity is not None and model._opacity.numel() > 0:
